...
class JobSearchApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('채용 공고 및 기업 정보 검색기')
        ...
        # 채용 공고 검색 버튼
        self.search_btn = QPushButton('채용 공고 검색', self)
        self.search_btn.clicked.connect(self.search_jobs)

        # CSV 파일 열기 버튼
        self.open_file_btn = QPushButton('채용 공고 CSV 열기', self)
    ...
    def search_jobs(self):
        ...
        if search_word:
            make_CSV(search_word)  # 채용공고 크롤링 실행
